...
(function (Game) {
    ...
    Engine.System.onInit = function () {
        if (Engine.Data.useLocalStorage) {
            Engine.Data.setID("com", "noa", "timwit");
        }
        else {
            Engine.Data.setID("c", "n", "timwit");
        }
...
(function (Game) {
    ...
    var Credits = /** @class */ (function (_super) {
        ...
        function Credits() {
            ...
            //noadev.xAligned = 1.5;
            noadev.yAligned = Game.CreditsFrame.spr.y + 5;
            ...
            var kal = new Utils.Text();
            kal.font = Game.FontManager.a;
            kal.scale = 1;
            kal.enabled = true;
            kal.pinned = true;
            kal.str = "GRAPHICS:";
            kal.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            kal.xAlignView = Utils.AnchorAlignment.MIDDLE;
            kal.yAlignBounds = Utils.AnchorAlignment.START;
            kal.yAlignView = Utils.AnchorAlignment.MIDDLE;
            //behe.xAligned = 1.5;
            kal.yAligned = noadev2.y + OFFSET_DOUBLE;
            var kal2 = new Utils.Text();
            kal2.font = Game.FontManager.a;
            kal2.scale = 1;
            kal2.enabled = true;
            kal2.pinned = true;
            kal2.str = "OSCAR SANCHEZ (KALPAR)";
            kal2.xAlignBounds = Utils.AnchorAlignment.MIDDLE;
            kal2.xAlignView = Utils.AnchorAlignment.MIDDLE;
            kal2.yAlignBounds = Utils.AnchorAlignment.START;
            kal2.yAlignView = Utils.AnchorAlignment.MIDDLE;
            kal2.xAligned = 0;
            kal2.yAligned = kal.y + OFFSET_SINGLE;
            ...
            //behe.xAligned = 1.5;
            behe.yAligned = kal2.y + OFFSET_DOUBLE;
        ...
        function MainMenu() {
            ...
            if (true || Game.IS_TOUCH) {
                ...
                if (Game.HAS_LINKS) {
                    ...
                    _this.moregames.text.yAligned = _this.moregamestouch.spr.y;
    ...
    var SpeedrunTimer = /** @class */ (function (_super) {
        ...
        function SpeedrunTimer() {
            ...
            */
            ...
            _this.textLevelName.scale = 0.7;
            _this.textLevelName.enabled = true;
            _this.textLevelName.pinned = true;
            _this.textLevelName.str = "TAS - L " + (Game.Level.index < 10 ? "0" : "") + Game.Level.index;
            ...
            _this.textDown.scale = Game.Level.speedrun? 0.55 : 1;
        ...
        SpeedrunTimer.prototype.fix = function () {
            if (!Game.SceneFreezer.paused) {
                ...
                this.textLevelName.xAligned = -10 - 1 - 4 - 2 + 2 + 1;
                this.textLevelName.yAligned = Game.Level.speedrun ? 2 : 2;
                ...
                this.textDown.yAligned = Game.Level.speedrun ? 2 + 10 : 9;
            }
            else {
                ...
                this.textLevelName.yAligned = Game.Level.speedrun ? -15 : -15;
                ...
                this.textDown.yAligned = Game.Level.speedrun ? -15 + 10 : -15 + 7;
            }
            /*
...
(function (Game) {
    var FRAMES;
    Game.addAction("init", function () {
        FRAMES = Game.FrameSelector.complex("loadingbar", Game.Resources.texgam, 199, 307, null, 0, false);
    });
    Game.MAX = 0.3;
...
(function (Game) {
    var fra;
    Game.addAction("configure", function () {
        fra = Game.FrameSelector.complex("lasbut", Game.Resources.texgam, 501, 374, null, 0, false)[0];
    });
...
(function (Game) {
    ...
    var TimerFrame = /** @class */ (function (_super) {
        ...
        TimerFrame.prototype.onViewUpdate = function () {
            ...
            spr.y = -Engine.Renderer.ySizeView * 0.5 - 8;
            sprpau.y = Engine.Renderer.ySizeView * 0.5 + 8;
        };
